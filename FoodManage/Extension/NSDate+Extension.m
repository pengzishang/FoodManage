...
- (BOOL)isSameWeekAsDate:(NSDate *)aDate {
    ...
    return components1.weekOfMonth == components2.weekOfMonth && fabs([self timeIntervalSinceDate:aDate]) < D_WEEK;
...
- (BOOL)isSameDayAsDate:(NSDate *)aDate {
    NSDateComponents *components1 = [[NSDate currentCalendar] components:NSCalendarUnitDay fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:NSCalendarUnitDay fromDate:aDate];
...
- (NSDate *)firstDayofWeek {
    ...
    NSDateComponents *comp   = [[NSDate currentCalendar] components:componentFlags fromDate:self];
    ...
    NSDateComponents *firstDayComp = [[NSDate currentCalendar] components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay fromDate:self];
    [firstDayComp setDay:day + firstDiff];
    return [[NSDate currentCalendar] dateFromComponents:firstDayComp];
}
...
- (NSDate *)lastDayofWeek {
    ...
    NSDateComponents *lastDayComp = [[NSDate currentCalendar] components:componentFlags fromDate:self];
    [lastDayComp setDay:day + lastDiff];
    return [[NSDate currentCalendar] dateFromComponents:lastDayComp];
}
